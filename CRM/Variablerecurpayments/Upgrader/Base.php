 ...
 */
class CRM_Variablerecurpayments_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Variablerecurpayments_Upgrader(
        'uk.co.mjwconsult.variablerecurpayments',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Variablerecurpayments_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
